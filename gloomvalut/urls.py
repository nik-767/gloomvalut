...
urlpatterns = [
    ...
    path('api/my-profile/', views.MyProfileUpdateAPI.as_view(), name='my_profile_api'), # <--- ADDED
    path('api/review-detail/<int:pk>/', views.ReviewDetailAPI.as_view(), name='review_detail_api'),
